...
import com.karlos.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		// a collection cidades é setada a parte do construtor
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "karloselyas2@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Lucia", "elyas.curso@gmail.com", "67334731190", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("40028922", "35563030"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38226834", cli1, c1);
		...
		clienteRepository.saveAll(Arrays.asList(cli1, cli2)); // cliente ja é salvo com seus endereços
