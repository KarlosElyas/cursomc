...
import com.karlos.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> listar(@RequestParam(value = "value") String email) {
	...
	@PreAuthorize("hasAnyRole('ADMIN')") // somente adm podem excluir clientes
	...
	public ResponseEntity<Void> uploadProfilePicture(@RequestParam(name = "file") MultipartFile file){
		...
		return ResponseEntity.created(uri).build(); // devolve a uri contendo a url para a imagem (arquivo)
	}
