...
public class Cliente implements Serializable {
	...
	private Integer id;
	private String nome;
	@Column(unique = true) // me parece desnecessário pois ja é tratado o erro na anotação ClienteInsert
	private String email;
	private String cpfOuCnpj;
	private Integer tipo;
	
	@JsonIgnore // pra nao aparecer o bcrypt da senha no json
	...
	public Set<Perfil> getPerfis() { // retorna a lista com os enumadores convertidos pra inteiro
